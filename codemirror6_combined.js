(function () {
    ...
    */
    ...
    const parser$3 = LRParser.deserialize({
      ...
      specialized: [{term: 287, get: (value, stack) => (tsExtends(value, stack) << 1)},{term: 287, get: value => spec_identifier$1[value] || -1},{term: 297, get: value => spec_word[value] || -1},{term: 63, get: value => spec_LessThan[value] || -1}],
      tokenPrec: 11358
    });
    ...
    */
    ...
    commands:
    	mkdir cm6
    	npm init -y
    	npm i @codemirror/basic-setup @codemirror/gutter  @codemirror/lang-javascript @codemirror/lang-json @codemirror/lang-html @codemirror/lang-css
    ...
    line wrap indent
    	https://discuss.codemirror.net/t/making-codemirror-6c-respect-indent-for-wrapped-lines/2881
    ...
    */
    ...
    cm6.Decoration=Decoration;
    cm6.ViewPlugin=ViewPlugin;
    cm6.RangeSetBuilder=RangeSetBuilder;
    cm6.keymap=keymap;
    cm6.base_exts=
    [
    	history(),
    	...
    	indentUnit.of('\t'),
    	keymap.of(defaultKeymap.concat(historyKeymap).concat(indentWithTab).concat(commentKeymap) )
    ];


    cm6.theme_exts=
    {
    	def_light: [defaultHighlightStyle],
    	def_dark: [oneDarkTheme, oneDarkHighlightStyle]
    };

    cm6.lang_exts={javascript:javascript(), json:json(), html:html(), css:css() };
    cm6.EditorView=EditorView;
    cm6.EditorState=EditorState;
